...
def run_sac(q_agent_1, q_agent_2, action_agent, logger, cfg):
    ...
    env_agent = AutoResetGymAgent(
        ...
        n_envs=int(cfg.algorithm.n_envs),
    )
    ...
    while replay_buffer.size() < cfg.algorithm.initial_buffer_size:
        ...
        acq_remote_agent(acq_workspace,t=cfg.algorithm.overlapping_timesteps,deterministic=False,n_steps=cfg.algorithm.n_timesteps - cfg.algorithm.overlapping_timesteps)
